# All credit goes to https://github.com/AliaksandrSiarohin/first-order-model
# Purpose: To integrate this in an Android Application with the help of Google Colab
# This code is taken directly from the open-source projet First-Order-Motion by AliaksandrSiarohin
...
def generate(button):
	...
	complete.layout.display = ''
	with output_widget:
		display(HTML('<video controls src="data:video/mp4;base64,%s" />' % b64encode(open('output.mp4', 'rb').read()).decode()))
